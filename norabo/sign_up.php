        ...
        <form class="card card-md" action="" method="post">
          <div class="card-body">
            ...
            <div class="mb-3">
              ...
              <input type="email" name ="email" class="form-control" placeholder="メールアドレス" autocomplete="off" required>
            </div>
            <div class="mb-3">
              <label class="form-label">ニックネーム</label>
              <input type="nick_name" name ="nick_name" class="form-control" placeholder="ニックネーム" autocomplete="off" required>
            </div>
            <div class="mb-3">
              <label class="form-label">パスワード</label>
              <div class="input-group input-group-flat">
                <input type="pw" name ="pw" class="form-control"  placeholder="パスワード"  autocomplete="off" required>
              </div>
            </div>
            <div class="mb-3">
                <!-- -->
